...
vector<Seed> seedlistdata(const int size)
{
	...
	int data[][3] =
	{
		292, 275, 67,	//3032P	sessile
		280, 286, 124,	//3032S sessile
		240, 211, 58,	//3033P Peduncated
		267, 360, 77,	//3033S	Peduncated
		243, 218, 48,	//3033P sessile
		286, 336, 61,	//3033S	sessile
		390, 301, 368,	//3034P	 sessile
		109, 211, 340,	//3034S	 sessile
		/*
		There are 8 polyps above +42 + 48
		...
		*/
		...
		387, 213, 127,//3072S p
		/*
		There are 42 polyps in above data.
		There will be another 48 polyps data below for more robust discrimination.
		*/
		239, 220, 66,//S 3072P
		265, 300, 69,//S  3072S
		 281, 201, 67,//S  3072P
		 ...
		 110, 340, 195,	 //	P 3098P
		 408, 209, 206,	 //	P 3098S
		 423, 313, 208,	  // carpet like 3100P
		 132, 197, 229,	  // carpet like 3100S
		 192, 242, 120,	  //  p	3101P
		 313, 268, 109,	  //  P	3101S
		 211, 318, 100,	  //  P	3108P
		 278, 233, 77,	  //  P	3108S
